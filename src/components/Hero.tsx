      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        ...
        >
          <div className="space-y-6">
            ...
            >
              ...
              <span className="relative inline-flex items-center gap-2 text-primary">
                <span className="animate-pulse">{t.hero.title2}</span>
            ...
            >
              <div className="group cursor-default transition-transform duration-300 hover:scale-125 hover:-translate-y-1">
                <div className="text-3xl font-bold text-emerald-500 group-hover:drop-shadow">5000+</div>
                <div className="text-sm text-emerald-700/80">{t.hero.students}</div>
              </div>
              <div className="group cursor-default transition-transform duration-300 hover:scale-125 hover:-translate-y-1">
                <div className="text-3xl font-bold text-orange-500 group-hover:drop-shadow">200+</div>
                <div className="text-sm text-orange-700/80">{t.hero.teachers}</div>
              </div>
              <div className="group cursor-default transition-transform duration-300 hover:scale-125 hover:-translate-y-1">
                <div className="text-3xl font-bold text-sky-500 group-hover:drop-shadow">50+</div>
                <div className="text-sm text-sky-700/80">{t.hero.schools}</div>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div className="relative" variants={fadeInRight}>
            ...
            <motion.div className="absolute -top-4 -right-4 w-24 h-24 bg-secondary rounded-full opacity-60 blur-2xl" />
            <motion.div
